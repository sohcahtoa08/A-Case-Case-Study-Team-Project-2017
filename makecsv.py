...
def main():
    ...
    getquery = """SELECT charges.disposition, cases.court_system, cases.type, cases.filing_date, parties.race, parties.sex, parties.height, parties.weight, parties.state, LOWER(parties.city) AS city, SUBSTR(parties.zip, 1, 5) AS zip, charges.description
                  FROM cases
